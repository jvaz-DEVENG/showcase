...
| [Sprite Animator](ferramentas/sprite-animator/) | Transforma uma spritesheet em animação pronta pro jogo: arraste, clique ou **Ctrl+V** para carregar a imagem, e a ferramenta **detecta o corte nas linhas reais da folha** (ou divide em grade regular, com margem e espaçamento finos). Apara a borda vazia igual em todos os frames, descarta frames vazios, lê linha a linha ou coluna a coluna, e toca no palco com scrub, atalhos de teclado e clique na célula para pular pro frame. Exporta **frames PNG separados**, **vídeo WebM** e o **código JS ou CSS** pronto para colar no minijogo. 100% no navegador. | [Demo ao vivo](https://jvaz-deveng.github.io/showcase/ferramentas/sprite-animator/) |
